...
public class GuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBtn_newxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(GuideActivity.this, MyMainActivity.class));
                finish();
            }
        });
    }
    ...
    private void isFirst() {
        SharedPreferences.Editor edit = getSharedPreferences("my_prf", 0).edit();
    ...
    private void moveDots() {
        ...
        mIn_vp.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                if (position == 2) {
                    mBtn_newxt.setVisibility(View.VISIBLE);
                }
                if (position != 2 && mBtn_newxt.getVisibility() == View.VISIBLE) {
                    mBtn_newxt.setVisibility(View.GONE);
                }
            }
    ...
    private void initView() {
        ...
        mBtn_newxt = (Button) findViewById(R.id.btn_text);
        LayoutInflater from = getLayoutInflater().from(GuideActivity.this);
        View view1 = from.inflate(R.layout.indicator1, null);
        View view2 = from.inflate(R.layout.indicator2, null);
        View view3 = from.inflate(R.layout.indicator3, null);
